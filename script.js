...
const setTopDate=(setDate,setMonth,setYear)=>{
  document.querySelector('[data-selected="full-date"]').innerHTML = setDate + " " + months[setMonth] + " " + setYear;
}

setTopDate(date,month,year);
